...
from models.model5.encoder_darkresnet import DarkResNet
from models.model5.detector_yolov3 import YOLOV3Detector
from models.model5.decoder import Decoder


class UDNet5(nn.Module):
    def __init__(self, in_size, num_classes, mode=None):
        ...
        self.encoder = DarkResNet(in_size)
