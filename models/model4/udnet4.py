...
from models.model4.encoder_darknet53 import DarkNet53
from models.model4.detector_yolov3 import YOLOV3Detector
from models.model4.decoder import Decoder


class UDNet4(nn.Module):
    ...
    def loss_detector(self, predict_list, target_list):
        ...
        loss_obj = F.l1_loss(pred[objs][..., 4], ious * tar[objs][..., 4])
