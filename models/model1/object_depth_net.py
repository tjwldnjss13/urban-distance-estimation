...
from models.model1.encoder import Encoder
from models.model1.detector import Detector
from models.model1.decoder import Decoder
...
class ObjectDepthNet(nn.Module):
    def __init__(self, in_size, num_classes, mode=None):
        ...
        self.decoder = Decoder(feat_size)
    ...
    def forward(self, x):
        ...
        if self.mode == 'detect':
            ...
            disparities = self.decoder(*en)

            if self.mode == 'depth':
                return disparities
            else:
                return detector, disparities
...
if __name__ == '__main__':
    ...
    detect_only = False
    model = ObjectDepthNet((256, 512), 9).cuda()
