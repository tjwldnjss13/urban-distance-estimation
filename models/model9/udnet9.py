...
from models.model9.encoder_srdarknet import SRDarkNet
from models.model9.detector_yolov3 import YOLOV3Detector
from models.model9.decoder import Decoder


class UDNet9(nn.Module):
    ...
    def loss_detector(self, predict_list, target_list):
        ...
        if pred[objs][..., 5:].device != tar[objs][..., 5:].device:
            print(pred[objs])
            print(tar[objs])
            exit()
        ...
        loss_box = lambda_box * giou_loss(pred_box, tar_box)
